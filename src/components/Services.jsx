        ...
        <Section id='how-to-use'>
            <div className='container'>
                ...
                <div className='relative'>
                    <div className=' relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:px-20 xl:h-[46rem]'>
                        ...
                        <div className='relative z-1 max-w-[17rem] ml-auto'>
                            ...
                            <ul className='body-2'>
                                {brainwaveServices.map((items,index) => {
                                    return <li
                                    className='flex items-start py-4 border-t border-n-6'    key={index}>
                                        <img
                                            width={24}
                                            height={24}
                                            src={check} alt="" />
                    ...
                    <div className='relatice z-1 grid gap-5 lg:grid-cols-2'>
                            ...
                            <div className='py-12 px-4 xl:px-8'>
                                ...
                                <ul className='flex items-center justify-between'>
                                    {brainwaveServicesIcons.map((items,index) => {
                                        return <li
                                            key={index} className={`flex items-center justify-center rounded-2xl ${index === 2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6 md:w-15 md:h-15'}`}>
